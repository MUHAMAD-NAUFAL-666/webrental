...
<html lang="en">
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
					...
					<div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							<!--begin::Form-->
							<!-- bagian <head> tetap seperti kode kamu, tidak dikurangi -->
 ...
 <form class="form w-100" method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="text-center mb-10">
                                ...
                                <div class="text-gray-500 fw-semibold fs-6">Have you already reset the password? <a href="{{ route('sign-in') }}" class="link-primary fw-bold">Sign in</a></div>
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <input type="password" placeholder="Repeat Password" name="password_confirmation" autocomplete="off" class="form-control bg-transparent" required />
                            </div>
